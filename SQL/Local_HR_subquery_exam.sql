...
-- 53. 이름에 K가 포함된 사원과 => K들어간 사원의 deptno
-- 같은 부서에서 일하는 
...
-- <부서위치가 DALLAS인 부서번호가 같은 사원 찾기.>
-- 1 부서의 위치가 DALLAS 인 부서번호 찾기.
...
-- 55. KING에게 보고하는 
-- 사원의 이름과 급여를 표시하시오.
-- emp => mgr(상사) => 사원의 mgr컬럼에 KING사원의 사원번호를 가지고 있으면 => KING이 상사.
-- mgr 에 KING 사원의 사원번호를 가지고 있는 사원 찾기.
-- 1 KING 사원의 사원번호 찾기.
