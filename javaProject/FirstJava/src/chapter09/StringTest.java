...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1==str2); // str1,str2,str3 은 참조변수.
		System.out.println(str1==str3); // 참조변수 == 주소값 비교.
		
		System.out.println("str1.equals(str3) => " + str1.equals(str3));
		
		// 특정 타입의 데이터를 => String 타입으로 변경. - 객체,문자열 로 바꾸는것.
		String str4 = ""+1;
		...
		System.out.println(str.length()); // 문자열의 길이 : 문자의 갯수.
		// index : 0 ~ str.leng()-1
